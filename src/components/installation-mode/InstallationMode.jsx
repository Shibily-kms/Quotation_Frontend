...
function InstallationMode() {
    ...
    const handleDelete = (current) => {
        ...
        if (check) {
            ...
            userAxios.delete(`/installation-mode?id=${current._id}`).then(() => {
                setData((state) => {
    ...
    return (
        <div className='installation-mode'>
            <div>
                ...
                <div className="test-report-div">
                    <div className="container">
                        <div className="title">
                            <Title header={'INSTALLATION MODES'} />
                        </div>
